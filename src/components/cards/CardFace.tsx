...
const faceSize = {
  tile: {
    ...
    frontContent: "px-4 pb-4 pt-5",
    title: "line-clamp-3 text-xl leading-snug",
    comment: "line-clamp-3 text-sm leading-6",
    date: "text-[10px]",
    backContent: "px-4 pb-4 pt-4",
    backMemo: "max-h-[calc(100%-4.75rem)] overflow-hidden text-sm leading-6",
  },
  preview: {
