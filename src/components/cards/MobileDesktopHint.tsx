    ...
    <aside className="sm:hidden rounded-[16px] border border-[#e3d7c6]/80 bg-[#fff8ec]/72 px-4 py-3 text-[#5f5346] shadow-[0_8px_22px_rgba(122,105,82,0.08)]">
      <div className="flex items-center justify-between gap-3">
        ...
        <a
          ...
          className="inline-flex min-h-10 shrink-0 items-center justify-center rounded-full border border-[#d8c8aa]/70 bg-white/62 px-3.5 py-2 text-xs font-semibold text-[#6f6253] transition hover:bg-white focus:outline-none focus:ring-2 focus:ring-[#d8c8aa]"
        >
          PC版を開く
        </a>
      </div>
